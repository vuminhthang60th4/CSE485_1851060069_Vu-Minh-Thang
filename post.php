...
<html lang="en">
  ...
  <div class="contain con-ma" style="width: 100%;">
        <form action="" enctype="multipart/form-data" method="post" class="form tab-con-ma">
            <table width="600" 3cellspacing="5" cellpadding="5" class="tab-con-ma" >
